    ...
    def insert(self, df, table):
        ...
        for i in range(df_insert.shape[0]):
            ...
            try:
                ...
                print('SQL Statement: {}'.format(insert_stm))
                print('Raised Error: {}'.format(e))


    @staticmethod
    def export_(df, file_, file_type, json_orient='index'):
        ...
        if isinstance(tables, list):
            ...
            for file_ , table in zip(files, tables):
                ...
                try:
                    ...
                    # export dataframe 
                    SQLServer.export_(df=df, file_=file_, file_type=file_type, json_orient=json_orient)
